...
def StartInstall():
    ...
    if response.status_code == 200:
        with open(InstallLoc + "/Amazing_Hacking_Tools/Launcher.pyw", "wb") as Install_Script_File:
    ...
    subprocess.Popen(["python", InstallLoc + "/Amazing_Hacking_Tools/Launcher.pyw"], creationflags=subprocess.CREATE_NEW_CONSOLE)
    sleep(0.5)
    quit()
